...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Tokoku">
    <meta name="keywords" content="Tokoku">
    <meta name="author" content="Tokoku">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +62 000000</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Kab.Bandung Timur,
                                    Rancaekek       </span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> smdewo@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Tokoku.</p>
                    </div>
                </div>
            </div>
        </div>
